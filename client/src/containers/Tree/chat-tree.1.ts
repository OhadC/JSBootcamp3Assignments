...
//                 currElement.item.HTMLlement = undefined
...
//         rootElement.addEventListener('dblclick', ondblclick)
//         rootElement.addEventListener('keydown', onkeydown)
//     }

//     function update(items: ITreeItem[]) {
//         items.forEach((item: ITreeItem) => {
//             const loadedItem: ITreeItem | undefined = loadedItems.find((loadedItem: ITreeItem) => item.group.id === loadedItem.group.id)
//             if (loadedItem) {
//                 updateTreeItem(item, loadedItem)
//             } else {
                
//             }
//         })

//         function updateTree(loadedItem: ITreeItem | undefined, parentLoadedItem: ITreeItem, updatedItem: ITreeItem) {
            
//         }

//         function updateTreeItem(loadedItem: ITreeItem, updatedItem: ITreeItem) {
...
//         rootElement.removeEventListener('dblclick', ondblclick)
